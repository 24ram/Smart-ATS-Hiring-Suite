    ...
    <div className="pb-12 max-w-7xl mx-auto">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="bg-purple-600 hover:bg-purple-700 px-4 py-2 rounded-lg text-white flex items-center gap-2 transition"
          >
          ...
          <button
            ...
            className="bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-lg text-white flex items-center gap-2 transition shadow-lg shadow-blue-900/20"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="relative">
                      <button 
                        ...
                        className={`px-3 py-1 rounded-full text-xs font-semibold flex items-center gap-1 ${getStageColor(candidate.stage)}`}
                      >
          ...
          {/* Matched Jobs */}
          {candidate.matched_jobs_details && candidate.matched_jobs_details.length > 0 && (
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 shadow-sm">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {candidate.matched_jobs_details.map(job => (
                  <div key={job.id} className="bg-gray-800 border border-gray-700 rounded-lg p-4 hover:border-gray-600 transition cursor-pointer" onClick={() => router.push(`/dashboard/jobs`)}>
                    <div className="flex justify-between items-start mb-2">
                      <h4 className="font-semibold text-white">{job.title}</h4>
                      {job.ai_score && (
                        <span className={`px-2 py-0.5 rounded text-xs font-bold ${getScoreColor(job.ai_score)}`}>
                          {job.ai_score}%
                        </span>
                      )}
                    </div>
